...
const Header = (props: Props) => {
  ...
  const isDeleteState = useMemo(() => deletePhotos.photos.length > 0, [
    deletePhotos.photos.length,
  ]);
  return (
    <Container>
      <div className="flex justify-between items-center py-2">
        ...
        <div className={`flex  divide-x divide-gray-600`}>
            ...
            <div className="flex items-center mx-4 justify-center">
              ...
              >
                ...
                <span className="text-gray-600 ml-2">
                  Delete {deletePhotos.photos.length} photos
                </span>
              </Button>
            </div>
          )}
          ...
          <Dropdown
            in={dropdown.state.isOpen}
            onChoose={dropdown.handleChooseDropdown}
          >
